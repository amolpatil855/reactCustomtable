...
```sh
Open https://github.com/shaggyshelar/LabtracNxt in your browser and login into your github account.
Fork this repository in your account.
Open terminal on your machine and type following commands.
git clone https://github.com/{YOUR_GITHUB_USERNAME/LabtracNxt
cd LabtracNxt
